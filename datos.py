...
param_beta_a = [
    # Canal 1: Facebook
    [[1.5, 4, 0.05, 0.10], [4, 2, 0.10, 0.20], [1, 2, 0.15, 0.45], [4.5, 1.5, 0.35, 0.50]],
    # Canal 2: Iteso
    [[1.5, 4, 0.05, 0.5], [4, 2, 0.05, 0.15], [1, 2, 0.40, 0.65], [4.5, 1.5, 0.45, 0.50]],
    # Canal 3: Plaza tlajomulco
    [[4, 2, 0.1, 0.2], [1, 2, 0.10, 0.25], [4.5, 1.5, 0.20, 0.50]]
    ]

param_beta_b = [
    # Canal 1: Facebook
    [[1.5, 4, 0.05, 0.07], [4, 2, 0.10, 0.18], [1, 2, 0.10, 0.35], [4.5, 1.5, 0.25, 0.60]],
    # Canal 2: Iteso
    [[1.5, 4, 0.05, 0.5], [4, 2, 0.05, 0.15], [1, 2, 0.30, 0.55], [4.5, 1.5, 0.50, 0.50]],
    # Canal 3: Plaza tlajomulco
    [[4, 2, 0.1, 0.2], [1, 2, 0.10, 0.25], [4.5, 1.5, 0.25, 0.45]]
    ]
